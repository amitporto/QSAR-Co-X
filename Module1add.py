...
def trainsetfit(X,y,ms):
    ...
    a,b,c,d=sl.fit_()
    if ms==int(fifthBoxTabThreer6c1.get()):
       pt=sl.pretreat(X)
       pt.to_csv('pt_train_'+str(corrl)+'_'+str(var)+'.csv')
    return a,b,c,d

def trainsetfit2(X,y,ms):
    ...
    sqs=sq(X,y,float(cthreshold),float(vthreshold),int(ms),flot,score,int(cvl))
...
Criterionx_Label = ttk.Label(tab2, text="Increment based selection:",font=("Helvetica", 12))
Criterionx = BooleanVar()
Criterionx.set(False)
Criterionx_Gini = ttk.Radiobutton(tab2, text='True', variable=Criterionx, value=True)
Criterionx_Entropy = ttk.Radiobutton(tab2, text='False', variable=Criterionx, value=False)
Criterionx_Label.place(x=50,y=80)
Criterionx_Gini.place(x=240,y=80)
Criterionx_Entropy.place(x=290,y=80)


flabel1 = Label(tab2, text= '% lambda decrease',font=("Helvetica", 12))
flabel1.place(x=350,y=80)
flabel2=Entry(tab2, width=10)
flabel2.place(x=500,y=80)

var1= IntVar()
C1 = Checkbutton(tab2, text = "FS-LDA",  variable=var1, \
                 font=("Helvetica", 12))
C1.place(x=200, y=110)
...
thirdLabelTabThreer2c1.place(x=35,y=135)
thirdEntryTabThreer3c1=Entry(tab2)
thirdEntryTabThreer3c1.place(x=165,y=135)
...
seventhLabelTabThree.place(x=35,y=235)
seventhEntryTabThree=Entry(tab2)
seventhEntryTabThree.place(x=165,y=235)
...
Criterion_Label.place(x=350,y=235)
Criterion_Gini.place(x=420,y=235)
Criterion_Entropy.place(x=470,y=235)
